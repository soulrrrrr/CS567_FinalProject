...
type Policy struct {
	...
	Comments          []Comment          `json:"comments" bson:"comments"`                     // comments of new policy
	SimulationResult  map[string]string  `json:"simulationResult" bson:"simulationResult"`     // simulation result of new policy
}
